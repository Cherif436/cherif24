              ...
              <div className="relative flex flex-col w-full bg-white border-0 rounded-lg shadow-lg outline-none focus:outline-none">
                ...
                <div className="relative flex flex-auto p-6 bg-white justify-evenly dark:bg-gray-800">
                  ...
                  <div className="col-span-12 p-2 rounded-lg sm:col-span-6 lg:col-span-4">
                    ...
                    <p className="flex items-center justify-center space-x-2"><GoLocation onClick={() => setShowModalMaps(true)} className="text-sky-800 animate-pulse hover:text-white" /><em onClick={() => setShowModalMaps(true)} className='animate-pulse'> 8 Groenstraat, Vlezenbeek</em></p>
